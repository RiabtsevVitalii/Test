...
public class MostRecentlyInsertedBlockingQueueTest {
    ...
    public void instantQueueWithNormalCapacity() {
        assertNotNull(new MostRecentlyInsertedBlockingQueue(1));
    }

    @Test
    public void sizeOfEmptyQueue() {
        MostRecentlyInsertedBlockingQueue<String> queue = new MostRecentlyInsertedBlockingQueue<>(1);
        int expectSize = 0;
    ...
    public void offerNullValue() {
        int capacity = 1;
        MostRecentlyInsertedBlockingQueue<String> queue = new MostRecentlyInsertedBlockingQueue<>(capacity);
        queue.offer(null);
    }
